...
void right_wheel_tick() {
  ...
  int val = digitalRead(ENC_IN_RIGHT_B); //TODO: Check logic with our encoders and change logic plus check wiring as well
...
void left_wheel_tick() {
   //TODO: Check logic with our encoders and change logic plus check wiring as well
...
void calc_pwm_values(const geometry_msgs::Twist& cmdVel) {
  ...
  //TODO: Change the logic for BTS7960
  if (cmdVel.angular.z != 0.0) {
 
    // Turn left //TODO: Change the logic for BTS7960
    if (cmdVel.angular.z > 0.0) {
      pwmLeftReq = -PWM_TURN;
      pwmRightReq = PWM_TURN;
    }
    // Turn right    //TODO: Change the logic for BTS7960
    else {
      pwmLeftReq = PWM_TURN;
      pwmRightReq = -PWM_TURN;
    }
